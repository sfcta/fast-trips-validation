...
temp_df = obs_links[['person_id','person_trip_id','A_id']].drop_duplicates(['person_id','person_trip_id'], keep='first')
temp_df = temp_df.rename(columns={'A_id':'o_taz'})
compare_paths = compare_paths.merge(temp_df, how='left')
# get the destination TAZ
temp_df = obs_links[['person_id','person_trip_id','B_id']].drop_duplicates(['person_id','person_trip_id'], keep='last')
temp_df = temp_df.rename(columns={'B_id':'d_taz'})
compare_paths = compare_paths.merge(temp_df, how='left')
